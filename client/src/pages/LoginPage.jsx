        ...
        <div className="auth-right-section">
          <div className="auth-form-card">
            <div className="auth-form-header">
              <div className="auth-badge-wide">
                <svg className="auth-badge-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                WELCOME BACK
              </div>
              <h2>{isForgotPassword ? 'Reset Password' : 'Login'}</h2>
              <p>{isForgotPassword ? 'Enter your email to reset your password' : 'Enter your email below to login to your account'}</p>
            </div>
